...
st.markdown("<h1 style='text-align: center; color: #EB6864; font-weight: bold;'>🍺 Open Pubs Appl 🍻</h1>", unsafe_allow_html=True)
...
st.write(f"Here {len(filtered_data)} pubs in {search_value}:")

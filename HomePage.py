...
st.markdown("<h1 style='text-align: center; color: #EB6864; font-weight: bold;'>🍺 Open Pubs App 🍻</h1>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; color: red;'>Pub Dataset</h2>", unsafe_allow_html=True)
